 ...
 */
public class JavaCCNewTask extends Task {
    ...
    public JavaCCNewTask() {
        cmdl.setVm(JavaEnvUtils.getJreExecutable("java"));
        
        // Added by DT
        try {
            Class.forName("javacc");
            cmdl.setClassname("javacc");
...
Project.MSG_VERBOSE);
        ...
        final File javaccJar = JavaCCNewTask.getArchiveFile(javaccHome);
